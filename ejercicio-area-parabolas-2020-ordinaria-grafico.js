(() => {
  const BOARD_ID = "area-parabolas-2020-board";
  const COLORS = {
    ink: "#1b1b18",
    muted: "#72756f",
    guide: "#b8bab4",
  ...
  function initAreaParabolas2020Graph() {
    ...
    board.create("text", [2, -0.2, "2"], {
      ...referenceTextStyle,
      anchorX: "middle",
      anchorY: "top",
    });
    board.create("text", [-0.06, 1, "1"], {
      ...referenceTextStyle,
      anchorX: "right",
    });
    board.create("text", [-0.06, 4, "4"], {
      ...referenceTextStyle,
      anchorX: "right",
    });
    board.create("text", [-0.06, 5, "5"], {
      ...referenceTextStyle,
      anchorX: "right",
    });

    board.create("text", [-1.28, 4.35, "P"], {
      ...textStyle,
      fontSize: compact ? 15 : 17,
      anchorX: "middle",
    });
    board.create("text", [compact ? 2.15 : 2.18, compact ? 0.65 : 0.63, "Q"], {
      ...textStyle,
      fontSize: compact ? 15 : 17,
      anchorX: "middle",
    });
    board.create("text", [compact ? -1.52 : -1.72, 3.45, "g"], {
      ...textStyle,
      color: COLORS.accent,
      fontSize: compact ? 18 : 21,
      cssStyle: "font-family: Newsreader, Georgia, serif; font-style: italic;",
    });
    board.create("text", [compact ? 2.16 : 2.25, 2.2, "f"], {
      ...textStyle,
      fontSize: compact ? 18 : 21,
      cssStyle: "font-family: Newsreader, Georgia, serif; font-style: italic;",
    });
    board.create("text", [0.52, 2.55, "R"], {
      ...textStyle,
      color: COLORS.accent,
    ...
    board.create("text", [compact ? 2.64 : 3.06, -0.18, "x"], {
      ...referenceTextStyle,
      anchorX: "right",
      anchorY: "top",
    });
    board.create("text", [0.08, 5.82, "y"], referenceTextStyle);

    board.update();
    container.dataset.ready = "true";
    window.areaParabolas2020Board = board;
  }

  if (document.readyState === "loading") {
    document.addEventListener("DOMContentLoaded", initAreaParabolas2020Graph, { once: true });
  } else {
    initAreaParabolas2020Graph();
  }
})();
